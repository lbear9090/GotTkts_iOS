//
//  PromotingEventsViewController.m
//  GotTkts
//
...
@interface PromotingEventsViewController ()<UITableViewDelegate, UITableViewDataSource, EventCellDelegate>
{
...
@implementation PromotingEventsViewController
...
- (void) refreshItems {
    ...
    [manager GET:REQUEST_SUB_PROMOTING parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject){
