...
- (void)setMenuState:(MFSideMenuState)menuState completion:(void (^)(void))completion {
    void (^innerCompletion)() = ^ {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:NOTIFICATION_MFSIDEMENU_CLOSE object:nil];
    };
    ...
    switch (menuState) {
        ...
        case MFSideMenuStateRightMenuOpen:
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:NOTIFICATION_MFSIDEMENU_RIGHTOPEN object:nil];
            break;
        default:
            break;
    }
