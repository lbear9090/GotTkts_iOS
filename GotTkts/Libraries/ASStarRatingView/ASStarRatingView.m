...
- (void)refreshStarsWithColor:(NSString*)color {
    
    if (color == nil) {
        color = @"gray";
    } else {
        if ( ![color isEqualToString:@"red"] && ![color isEqualToString:@"green"] && ![color isEqualToString:@"yellow"]) {
            color = @"gray";
        }
    }
    ...
    _notSelectedStar = [[UIImage imageNamed:[NSString stringWithFormat:@"%@_not_selected_star", color]] retain];
    _selectedStar = [[UIImage imageNamed:[NSString stringWithFormat:@"%@_selected_star", color]] retain];
    _halfSelectedStar = [[UIImage imageNamed:[NSString stringWithFormat:@"%@_half_selected_star", color]] retain];
...
- (void)setupView {
    ...
    [self refreshStarsWithColor: nil];
}
...
- (void)setMaxRating:(int)maxRating {
    ...
    [self setNeedsLayout];
    [self refreshStarsWithColor:self.starColor];
}
