...
const CGFloat kHTHorizontalSelectionListLabelCellInternalPadding = 0;
...
- (void)commonInit {
    ...
    _buttonInsets = UIEdgeInsetsMake(0, 0, 0, 0);
    _selectionIndicatorHeight = 5;
...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.dataSource respondsToSelector:@selector(selectionList:viewForItemWithIndex:)]) {
        ...
        width = [UIScreen mainScreen].bounds.size.width / [self.dataSource numberOfItemsInSelectionList:self];
